...
online_deploy:
  ...
  script:
    ...
    # - docker run --label dpmonline -d -p 80:80 -v /usr/local/file:/usr/local/file registry.cn-hangzhou.aliyuncs.com/zebra_dev/dpm-web:${CI_COMMIT_SHORT_SHA};rm -f /tmp/dpm-web.tar;
